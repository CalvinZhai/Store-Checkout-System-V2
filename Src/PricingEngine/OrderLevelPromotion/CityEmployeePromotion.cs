...
{
    public class CityEmployeePromotion : BaseOrderPromotion
    {
        ...
        {
            return string.Format("City Employee At Additional {0}% Off", this.RuleObj.off);
        }

        protected override bool Applicable()
        { return this.context.IsCityEmployee; }
